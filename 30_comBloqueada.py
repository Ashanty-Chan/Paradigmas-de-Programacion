...
#==================================================
# Enviar obejto mensaje con comunicación bloqueada
...
if __name__ == "__main__":
    ...
    #===========================================================
    # Mándalo al siguente y si eres el último mándalo al primero
    #===========================================================
    ...
    # Si no soy par
        ...
        #=========================================
        m = comm.recv(spurce=fuente)
        comm.send(s,dest=destino)
    
    print("Soy el proceso ", rank ,", el resultado es ", len(m.x),",", m.p)

    #============================================================
    # Para una comunicación más rápida se utilizan arreglos numpy
    ...
    if rank == 0:
        ...
        comm.Send(daya, dest=1, tag=13)
    elif rank ==1:
        data = numpy.empty(10, fdtype=numpy.float64)
